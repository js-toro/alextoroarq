		...
		<section className={`${Styles.section}`}>
			<div className={`${Utils.container} ${Styles.category}`}>
				<p>
					...
					satisfacción, en este album gráfico, llos diseños de vivienda
					unifamiliar más representativas de Alex Toro Arquitectos.
				</p>
			</div>

			{!isLoading && (
				<div className={`${Styles.projects}`}>
					{filterByCategory(Category.Unifamiliar)?.map((project: IProject) => (
						<div key={project.id}>
							<Link
